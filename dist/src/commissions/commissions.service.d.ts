...
export declare class CommissionsService {
    ...
    private audit;
    private engine;
    constructor(prisma: PrismaService, audit: AuditService, engine: CommissionEngineService);
    ...
    findMySummary(tenantId: string, sellerId: string): Promise<{
    ...
    processInvoice(tenantId: string, dto: {
        saleId: string;
