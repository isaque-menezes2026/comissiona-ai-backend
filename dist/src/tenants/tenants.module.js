...
exports.TenantsModule = TenantsModule = __decorate([
    (0, common_1.Module)({ providers: [tenants_service_1.TenantsService], controllers: [tenants_controller_1.TenantsController], exports: [tenants_service_1.TenantsService] })
], TenantsModule);
